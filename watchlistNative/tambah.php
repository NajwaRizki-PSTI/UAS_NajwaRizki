...
<div class="p-4 container" >
        <div class="row">
            <h3 class="mb-2">Tambah Data Watchlist</h1>
            <section>
                <a href="indexAdmin.php">back</a>
            </section>
            <div class="col-md-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="watchlist_id" id="watchlist_id" value="<?= $watchlist['poster'] ?>" autocomplete="off">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="genre" id="genre" placeholder="Genre" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Pemeran</label>
                        <input type="text" class="form-control" name="aktor" id="aktor" placeholder="Pemeran" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tahun_rilis" id="tahun_rilis" placeholder="Tahun Rilis" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
