            ...
            <li class="nav-item dropdown user-menu pe-5">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-3" style="border-color: black">
                    <li class="user-header pe-5 ps-5">
                        ...
                        <h5 style="text-align: center;" class="text-secondary"><?= $user['role']?></h5>
                    </li>
                    <li>
                        <a href="profileAdmin.php" class="btn btn-secondary btn-flat">Pofile</a>
...
<section class="p-3">
        <div class="container">
            ...
            <a href="tambah.php">
                    <button class="btn btn-secondary mb-2">Tambah Watchlist</button>
                </a>
            ...
            <table class="table table-hover bg-white table-wrapper">
                ...
                <tr>
                    ...
                    <td> <?= $w['tahun_rilis'] ?> </td>
                    <td>
                        <a href="edit.php?watchlist_id=<?= $w['watchlist_id'] ?>">
                            <button class="btn btn-secondary">Edit</button>
                        </a>
                        <a href="hapus.php?id=<?= $w['watchlist_id'] ?>">
